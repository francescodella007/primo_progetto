...
def contatti(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            # a questo punto possiamo usare i dati validati
            ...
            nuovo_contatto = form.save() # salva il nuovo contatto nel database
    ...
    # Se la richiesta HTTP usa il metodo GET o qualsiasi altro metodo, allora crea il form di default vuoto
    else:
        form = FormContatto()
...
def lista_contatti(request):
    contatti = Contatto.objects.all() # recupera tutti i contatti dal database
